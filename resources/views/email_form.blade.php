    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('store_emails') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="number_of_emails" id="number_of_emails" class="form-control">
            </div>
            <div class="mb-3">
                <label for="number_of_emails" class="form-label">Account</label>
                <select name="account_id" class="form-control">
                    @foreach ($all_email_from as $account)
